...
MySQL - 5.5.5-10.4.13-MariaDB : Database - micromac_admin
*********************************************************************
*/
...
insert  into `model_has_roles`(`role_id`,`model_type`,`model_id`) values (1,'App\\Models\\User',2),(1,'App\\Models\\User',5),(2,'App\\Models\\User',1),(2,'App\\Models\\User',4),(3,'App\\Models\\User',3);
...
insert  into `users`(`id`,`name`,`email`,`email_verified_at`,`password`,`remember_token`,`created_at`,`updated_at`,`role`,`usr_pic`) values (1,'Sarzil','admin@gmail.com',NULL,'$2y$10$/8eXh/SK1UVSDEk180qVs.XRDqQWSEck4ioMmLmBHJmMi3mYTte4u',NULL,'2020-12-16 16:56:59','2020-12-16 16:56:59',NULL,NULL),(2,'Mueed Hasan Sarzil','sarzilaiub@gmail.com',NULL,'$2y$10$s95AbFq8XM0chiCwTqn1V.rB.Vmhu01tnf2GlD//Euch00a0H0tPS',NULL,'2020-12-17 14:50:10','2020-12-17 14:50:10',NULL,NULL),(3,'Sagor','sagor@gmail.com',NULL,'$2y$10$MKTZxuT9Kl1C4P3i3CE1H.h9WNdRhAyw5eZ3qiU8vMcQmd6mthOkK',NULL,'2020-12-18 05:10:02','2020-12-26 09:22:45',NULL,NULL),(4,'Mueed Hasan Sarzil','sarzil31@gmail.com',NULL,'$2y$10$vnqtp.PnMf6dUQCp1VAk5.9jrTABy5Orfic.bbye6KaByW/K/9o8G',NULL,'2020-12-26 08:30:13','2020-12-26 08:30:13',NULL,NULL),(5,'Khadiza','bob@gmail.com',NULL,'$2y$10$LGWNYGTZYdWSXY7Rc3C4P.CZLgeyl8jqxan4rvsxBgdfDwthI9qUC',NULL,'2021-04-20 17:37:03','2021-04-20 17:37:03',NULL,NULL);
